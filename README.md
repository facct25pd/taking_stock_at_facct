...
The analyses / code to generate figures in the paper can be found under `src/`. The required csv files to run the analyses are included in the repository (under `data/`), but can also be downloaded directly from [polis](https://pol.is/report/r8zcsaxppvvhrbnvkceth).
