...
counts = df_filtered.groupby(['Statement_Type', 'Statement_Subtype']).size().reset_index(name='count')
...
def draw_node(ax, pos, text, count=None, box_color='lightblue', text_size=10, box_width=1.2):
...
draw_edge(ax, positions['root'], positions['descriptive'], descriptive_total, offset_x=0.5)
